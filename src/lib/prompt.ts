...
each beat is one spoken chunk ("say"/"narration", 1-2 sentences, <=320 chars but aim for ~31 spoken
...
- {"kind":"terminal","narration":"<=260 chars — the typewriter animates while it plays, so this one may run longer","lines":["$ command","output", 1-10 lines, each <=60 chars]}
...
- {"kind":"question","narration":"<=190 chars / ~30 spoken words — the whole scene","text":"<=180","hint":"<=110 optional"} — ending challenge for comments
...
- {"kind":"quote","narration":"<=190 chars / ~30 spoken words — the whole scene","text":"<=200 the exact quotation","author":"<=40 optional"} — styled quotation card; ONLY real, correctly attributed quotes (or mark as proverb/saying)
...
ones: no single beat may exceed ~31 spoken words, because a beat is one visual step and the picture
...
- every "say"/beat: max 320 chars; scene "narration": max 190 chars (terminal 260)
...
from line 1 covering all lines; terminal lines max 60 chars; say max 320; narration max 190 (terminal 260);
