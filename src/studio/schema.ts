...
export const CIRCUIT_PARTS = ["battery", "bulb", "switch", "resistor", "and", "or", "not", "led"] as const;
...
export const CURVE_SHAPES = ["linear", "exp", "log", "sine", "bell", "supply", "demand", "scurve", "ushape"] as const;
