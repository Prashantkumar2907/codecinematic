...
create index if not exists idx_projects_user_slug on public.projects(user_id, slug) where slug is not null;
...
create index if not exists idx_subscriptions_provider_customer_id on public.subscriptions(provider_customer_id) where provider_customer_id is not null;
...
create index if not exists idx_usage_counters_user_metric_window on public.usage_counters(user_id, metric_key, window_end desc);
...
create index if not exists idx_feature_overrides_user_key on public.feature_overrides(user_id, feature_key);
...
create index if not exists idx_project_assets_user_created on public.project_assets(user_id, created_at desc);
...
create index if not exists idx_audio_generations_user_created on public.audio_generations(user_id, created_at desc);
...
create index if not exists idx_video_analysis_jobs_user_created on public.video_analysis_jobs(user_id, created_at desc);
...
drop policy if exists "project_scenes_select_own" on public.project_scenes;
drop policy if exists "project_scenes_insert_own" on public.project_scenes;
drop policy if exists "project_scenes_update_own" on public.project_scenes;
drop policy if exists "project_scenes_delete_own" on public.project_scenes;
drop policy if exists "important_line_rules_select_own" on public.important_line_rules;
drop policy if exists "important_line_rules_insert_own" on public.important_line_rules;
drop policy if exists "important_line_rules_update_own" on public.important_line_rules;
drop policy if exists "important_line_rules_delete_own" on public.important_line_rules;
...
drop policy if exists "audio_generations_select_own" on public.audio_generations;
drop policy if exists "audio_generations_insert_own" on public.audio_generations;
drop policy if exists "audio_generations_update_own" on public.audio_generations;
